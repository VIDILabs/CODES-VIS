define(["p4/core/pipeline", "p4/core/datastruct", "p4/core/arrays"], function(pipeline, dataStruct, arrays){
    ...
    return function Dragonfly(model) {
        var dfly = {},
            NUM_ROUTER = model.numRouter || 264,
            NUM_GROUP = model.numGroup || 33,
            NUM_NODE = model.numNode || 1056,
            ROUTER_PER_GROUP = NUM_ROUTER / NUM_GROUP,
            TERMINAL_PER_ROUTER = NUM_NODE / NUM_ROUTER,
            ...
            var router_per_group = NUM_ROUTER / NUM_GROUP,
                globalLinks = [];
