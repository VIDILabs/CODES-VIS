...
},{"d3-array":3,"d3-collection":4,"d3-color":5,"d3-format":6,"d3-interpolate":7,"d3-time":9,"d3-time-format":8}],3:[function(require,module,exports){
(function (global, factory) {
...
},{"../lib/colorbrewer/colorbrewer.js":1}],13:[function(require,module,exports){
(function (global){
...
module.exports = function WebGL(option){
    ...
    var webgl = {},
        arg = option || {},
        container = arg.container || "body",
        canvas = document.createElement("canvas"),
        width = arg.width || 400,
        height = arg.height || 300,
        margin = arg.margin || {left: 0, right: 0, top: 0, bottom: 0},
    ...
    function setAttribute(name, value) {
        if(Array.isArray(value) || ArrayBuffer.isView(value)){
            if(attribute[name].value != value){
                ...
                ctx.bufferData(ctx.ARRAY_BUFFER, value, ctx.DYNAMIC_DRAW);
    ...
    webgl.texture = function(type, name, dim, value){
        ...
        Object.defineProperty(webgl.texture, name, {
            ...
            set: function(texArray) {
                ...
                // var tid = Object.keys(texture).indexOf(name);
                // ctx.activeTexture(ctx.TEXTURE0 + tid);
                // ctx.bindTexture(ctx.TEXTURE_2D, texture[name].ptr);
                // texture[name].location = ctx.getUniformLocation(program, name);
                // ctx.uniform1i(texture[name].location, tid);
            }
        });
        return webgl;
    }
    ...
    webgl.shader = function(arg){
        ...
        shader.init = function() {
            ...
            if(deps.length === 0){
                deps = [].concat(Object.keys(attribute), Object.keys(uniform), Object.keys(texture), Object.keys(varying));
            }
            // console.log(deps);
